...
RUN wget https://dlcdn.apache.org/tomcat/tomcat-10/v10.1.0/bin/apache-tomcat-10.1.0.tar.gz --no-check-certificate
...
COPY  target/simple-app-3.0.0-SNAPSHOT.war  /opt/tomcat/webapps/simple-app-3.0.0-SNAPSHOT.war
EXPOSE 8080
